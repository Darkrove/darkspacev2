...
export function NewBanner(props: NewBannerProps) {
  ...
  return (
    ...
    >
      ...
      <span className="flex gap-2 items-center font-regular shrink-0 bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent decoration-primary-600">
